...
document.addEventListener('click', e => {
    ...
    // ✅ ИСПРАВЛЕНО (Devin V2): триггер «Перезвонить мне» / «Связаться с нами»
    // — это и текст в шапке (.callme-back__text), и кнопки button.callme-back / a.callme-back
    // на страницах /about/, /vikup/, /clients/ и т.п.
    const callMeBackBtn = e.target.closest('.callme-back__text, button.callme-back, a.callme-back, .js-callme-back')
...
(function () {
    ...
    function nearBottomForm() {
        // П-4: на мобиле прячем «Вверх» когда виден футер или форма с чекбоксом
